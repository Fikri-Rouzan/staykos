        ...
        <form action="{{ route('check-booking.show') }}"
            ...
            <div id="InputContainer" class="flex flex-col gap-[18px]">
                ...
                <div class="flex flex-col w-full gap-2">
                    ...
                    <label
                        class="flex items-center w-full rounded-full p-[14px_20px] gap-3 bg-white ring-1 ring-[#F1F2F6] focus-within:ring-[#91BF77] transition-all duration-300 @error('phone') border-red-500 @enderror">
