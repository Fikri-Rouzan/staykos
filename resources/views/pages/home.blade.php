...
@section('content')
    ...
    <section id="Popular" class="flex flex-col gap-4">
        <div class="flex items-center justify-between px-5">
            <h2 class="font-bold">Popular Boarding Houses</h2>
            <a href="#">
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <div class="flex items-center gap-[6px]">
                                        <img src="assets/images/icons/profile-2user.svg" class="w-5 h-5 flex shrink-0"
                                            alt="icon">
                                        <p class="text-sm text-ngekos-grey">{{ $boardingHouse->rooms->count() }} Rooms</p>
                                    </div>
                                    <hr class="border-[#F1F2F6]">
                                    <p class="font-semibold text-lg text-ngekos-orange">
                                        Rp {{ number_format($boardingHouse->price, 0, ',', '.') }}
                                        <span class="text-sm text-ngekos-grey font-normal">/Month</span>
                                    </p>
                                </div>
                            </div>
                        </a>
                ...
                <a href="{{ route('city.show', $city->slug) }}" class="card">
                    <div
                        ...
                        <div class="flex flex-col gap-[2px]">
                            ...
                            <p class="text-sm text-ngekos-grey">{{ $city->boardingHouses->count() }} Boarding Houses</p>
                        </div>
                    </div>
                </a>
            @endforeach
